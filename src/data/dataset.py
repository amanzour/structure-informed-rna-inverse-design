...
class RNADesignDataset(data.Dataset):
    ...
    Args:
        ...
        radius: maximum distance in space to qualify for edges in DBSCAN
        primary_dist: minimum distance on sequence to qualify for edges in DBSCAN
    ...
    def __init__(
        ...
        self.featurizer = RNAGraphFeaturizer(
            split=split, radius=radius, primary_dist=primary_dist, base_pairing=base_pairing, num_rbf=num_rbf, max_num_conformers=max_num_conformers,
...
class BatchSampler(data.Sampler):
    ...
    def __init__(
        ...
        self._form_batches()
        # ==============modified====================
        # the if statement is commented out from original
    ...
    def _form_batches(self):
        ...
        # ======================modified=======
        self.batches = [[i] for i in self.idx]
        # ====================end==============
